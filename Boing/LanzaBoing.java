...
public class LanzaBoing {
        ...
        objs.add(new Cuadrado(new Posicion(70, 5), 1, 1));
        objs.add(new Cuadrado(new Posicion(70, 30), 1, -1));
        objs.add(new Rectangulo(new Posicion(90, 10), 1, -1));
        objs.add(new Rectangulo(new Posicion(40, 15), 1, 1));
        objs.add(new Rectangulo(new Posicion(5, 10), 1, -1));
        objs.add(new Izan(new Posicion(20, 10), 1, -1));
